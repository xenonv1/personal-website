<template>
  ...
  >
    <p
      class="font-light text-xl pb-[2rem] font-accent-font text-accent-text max-md:text-lg 2xl:text-3xl"
    >
      Hi, my name is
    </p>
    <h1 class="text-5xl font-bold pb-[1rem] max-md:text-4xl 2xl:text-7xl">
      Niklas Borresch
    </h1>
